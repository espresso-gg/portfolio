...
const NAV_HTML = `
  <nav id="nav">
    <div class="nav-side">
      ...
      <span class="nav-loc">ISLAMABAD, PAKISTAN</span>
    </div>

    <div class="nav-pill" id="nav-pill">
      <div class="nav-id">
        <a class="nav-avatar" href="/#work" aria-label="Uzair Khurshid — home">
...
const MENU_HTML = `
  <div class="menu-overlay" id="menu-overlay" role="dialog" aria-modal="true" aria-label="Menu">
    ...
    <p class="menu-footer">ISLAMABAD, PAKISTAN</p>
  </div>
`;
...
const CONTACT_EMAIL = 'hello@uzair.dev';
...
const CONTACT_HTML = `
  ...
  <aside class="contact-drawer" id="contact-drawer" role="dialog" aria-modal="true" aria-labelledby="cd-title">
    ...
    <div class="cd-body">
      ...
      <h2 class="cd-title" id="cd-title">Shall we make something unforgettable?</h2>
      <p class="cd-intro">Every experience begins with a mood. Tell me what you’re shaping, and let’s give it a reason to stay.</p>
